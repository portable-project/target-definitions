...
IF "%~1" neq "" (
	set Portable.RemoteTasks.Manager.Login=ppw_power
	set Portable.RemoteTasks.Manager.Password=97408BB2C280
	set defFile=power.target.pdsl
	set archName=POWER
	set asmListing=listing.asm
